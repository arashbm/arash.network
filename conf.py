...
# Arash Badie-Modiri build configuration file, created by
# `ablog start` on Thu Aug 25 17:01:53 2022.
#
...
blog_title = "Arash Badie‑Modiri"

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = "https://arash.network/"
...
blog_authors = {
    "Arash Badie-Modiri": ("Arash Badie-Modiri", None),
}
...
project = "Arash Badie‑Modiri"
copyright = "2022, Arash Badie‑Modiri, under a Creative Commons Attribution" \
...
htmlhelp_basename = "ArashBadie-Modiridoc"
